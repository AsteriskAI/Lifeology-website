            ...
            children: [
              ...
              Container(
                ...
                child: Column(children: [
                  Text(
                    'Calender',
                    style: TextStyle(fontSize: 40, fontFamily: 'PTSERIFF'),
                  ),
                  Row(
                    children: [
                      Image.asset('cal.png'),
                      Text(
                        "FEMERA's calender for august,\nhere you will see the dates of future events\nin august.",
                        style: TextStyle(fontSize: 35, fontFamily: 'PTSERIFF'),
                      ),
                    ],
                  )
                ]),
